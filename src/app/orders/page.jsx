        ...
        <Container>
            <div className={`min-h-screen pt-20 px-6 ${isToggleSidebar ? 'ml-0' : 'ml-64'} transition-all duration-300`}>
                ...
                <div className="grid grid-cols-4 gap-3 mt-8">
                    ...
                    <div className="bg-blue-500 rounded-lg p-4 relative">
                        <h4 className="text-white text-2xl font-semibold">398</h4>
                        <p className="mt-2 text-white">shipped_orders</p>
                        <MdLocalShipping className="absolute -top-5 right-0 text-blue-300" size={50}/>
                    </div>
                    <div className="bg-green-500 rounded-lg p-4 relative">
                        ...
                        <AiFillShopping className="absolute -top-5 right-0 text-green-300" size={50}/>
                    </div>
                ...
                <section className="bg-white rounded-lg my-10 dark:bg-09">
                    ...
                    <div className="grid grid-cols-4 gap-6 p-3">
                        <div>
                            ...
                            <select name="" className="bg-01 dark:border-02 dark:bg-bgHover text-02 text-sm w-64 h-10 border border-06 rounded-sm outline-0 dark:text-10">
                        ...
                        <div>
                            ...
                            <select name="" className="bg-01 text-sm text-02 w-64 h-10 border border-06 rounded-sm outline-0 dark:border-02 dark:bg-bgHover dark:text-10">
                    ...
                    <div className="p-3">
                        <table className="table-auto w-full border-collapse">
                            <thead>
                                <tr className="text-white bg-08">
                                    <th className="p-4 border border-06 text-left min-w-28 text-sm">
                                        <input className="mr-1" type="checkbox" />
                                        UID
                                    </th>
                                    <th className="p-4 border border-06 text-left min-w-36 text-sm">client</th>
                                    <th className="p-4 border border-06 text-left min-w-32 text-sm">Product</th>
                                    <th className="p-4 border border-06 text-left min-w-32 text-sm">Amount</th>
                                    <th className="p-4 border border-06 text-left min-w-32 text-sm">Payment</th>
                                    <th className="p-4 border border-06 text-left min-w-32 text-sm">Status</th>
                                    <th className="p-4 border border-06 text-left min-w-32 text-sm">Issue Date</th>
                                    <th className="p-4 border border-06 text-left min-w-40 text-sm">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className="dark:bg-11">
                                    ...
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <h4 className="text-sm text-02 whitespace-nowrap font-normal dark:text-10">Tahmina Bonny</h4>
                                        </div>
                                    </th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">(2) item</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">$56.00</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">bkash</th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 dark:border-02"><p className="bg-green-200 rounded-lg w-20 h-6 text-green-600 text-sm">Approved</p></th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">15/06/2022 14:02</th>
                                ...
                                <tr className="dark:bg-11">
                                    ...
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <h4 className="text-sm text-02 whitespace-nowrap font-normal dark:text-10">Miron Mahmud</h4>
                                        </div>
                                    </th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">(1) item</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">$45.00</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">tap tap send</th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 dark:border-02"><p className="bg-purple-300 rounded-lg w-20 h-6 text-purple-600 text-sm">Pending</p></th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">15/06/2022 14:02</th>
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex gap-3">
                                            <Link href='/productdetails'>
                                ...
                                <tr className="dark:bg-11">
                                    ...
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <h4 className="text-sm text-02 whitespace-nowrap font-normal dark:text-10">Labonno Khan</h4>
                                        </div>
                                    </th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">(3) item</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">$68.00</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">nagad</th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 dark:border-02"><p className="bg-red-300 rounded-lg w-20 h-6 text-red-600 text-sm">Blocked</p></th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">15/06/2022 14:02</th>
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex gap-3">
                                            <Link href='/productdetails'>
                                ...
                                <tr className="dark:bg-11">
                                    ...
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <h4 className="text-sm text-02 whitespace-nowrap font-normal dark:text-10">Johara Khatun</h4>
                                        </div>
                                    </th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">(5) item</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">$53.00</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">payoneer</th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 dark:border-02"><p className="bg-green-300 rounded-lg w-20 h-6 text-green-600 text-sm">Approved</p></th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">15/06/2022 14:02</th>
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex gap-3">
                                            <Link href='/productdetails'>
                                ...
                                <tr className="dark:bg-11">
                                    ...
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <h4 className="text-02 whitespace-nowrap font-normal text-sm dark:text-10">Kurulus Osman</h4>
                                        </div>
                                    </th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 dark:border-02">(4) item</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">$79.00</th>
                                    <th className="border border-07 px-4 py-5 text-02 dark:text-10 font-normal text-sm dark:border-02">cash on delivery</th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 dark:border-02"><p className="bg-purple-300 rounded-lg w-20 h-6 text-purple-600 text-sm">Pending</p></th>
                                    <th className="border border-07 px-4 py-5 text-02 font-normal dark:text-10 text-sm dark:border-02">15/06/2022 14:02</th>
                                    <th className="border border-07 px-4 py-5 dark:border-02">
                                        <div className="flex gap-3">
                        ...
                        <div className="mt-4 flex justify-between items-center">
                            ...
                            <ul className="flex cursor-pointer">
                                ...
                                <li className="w-10 h-10 rounded-full text-02 dark:bg-08 dark:text-04 bg-08 flex items-center justify-center mx-1">1</li>
